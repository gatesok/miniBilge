...
public class LeaderboardController : ControllerBase
{
    ...
    /// </summary>
    [HttpGet]
    public async Task<ActionResult<List<LeaderboardEntryDto>>> GetLeaderboard([FromQuery] int topN = 50)
    {
        try
        {
            var leaderboard = await _leaderboardService.GetGlobalLeaderboardAsync(topN);
