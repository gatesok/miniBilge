...
/// Günlük Kelime Meydan Okuması hakkını yerel olarak takip eder.
///
/// Kural:
...
class VocabAttemptStore {
  ...
  static String _attemptsKey(String childId) => 'vocab_attempts_left_$childId';
  static String _resetAtKey(String childId) => 'vocab_attempts_reset_at_$childId';
  ...
  /// İlk denemeden 24 saat geçtiyse hakkı 3'e sıfırlar.
  static Future<void> _resetIfExpired(
    ...
    if (raw == null) return; // henüz hiç deneme yapılmamış
