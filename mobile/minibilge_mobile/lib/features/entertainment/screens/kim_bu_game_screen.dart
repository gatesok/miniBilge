        ...
        children: [
                ...
                child: GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(color: sel ? Colors.white : Colors.white30),
                    ),
                    child: Text(d,
                        style: GoogleFonts.nunito(
                            color: Colors.white,
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text('Başla 🔍',
                  style:
                      GoogleFonts.luckiestGuy(fontSize: 16, letterSpacing: 1)),
            ),
          ),
        ],
      ),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Cevap şıkları
          if (!answered) ...[
            ...subject.options.map((opt) => _OptionTile(
                  label:    opt,
              ...
              child: Column(
                children: [
                  ...
                  if (!isCorrect) ...[
                    ...
                    Text('Doğru cevap: ${subject.correctAnswer}',
                        textAlign: TextAlign.center,
                        style: GoogleFonts.nunito(
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: isLast ? Colors.white38 : Colors.white12,
        ),
      ),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
              color: selected ? const Color(0xFF4DA6FF) : Colors.white.withOpacity(0.2)),
        ),
        child: Row(
          children: [
            Icon(
