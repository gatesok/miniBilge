...
abstract class _Initial implements AvatarState {
...
abstract class _Loading implements AvatarState {
...
class _$LoadedImpl implements _Loaded {
  ...
  final List<AvatarItem> _ownedItems;
  @override
  @JsonKey()
  ...
  @override
  String toString() {
    return 'AvatarState.loaded(availableItems: $availableItems, ownedItems: $ownedItems, equippedItems: $equippedItems)';
  }
...
abstract class _Error implements AvatarState {
