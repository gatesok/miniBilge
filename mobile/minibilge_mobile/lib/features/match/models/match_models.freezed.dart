...
class _$MatchQuestionImpl implements _MatchQuestion {
  ...
  @override
  String toString() {
    return 'MatchQuestion(id: $id, matchSessionId: $matchSessionId, questionId: $questionId, questionOrder: $questionOrder, questionText: $questionText, correctAnswer: $correctAnswer, options: $options, hasLatex: $hasLatex)';
  }
