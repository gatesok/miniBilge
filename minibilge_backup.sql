...
\restrict NbNUHiuLQTyCMvXfptp07SI4ZFFbV7t7WObyCe5U4OEyO8W4BhqmZont9ESYVsN
...
--
-- Name: __EFMigrationsHistory_PostgreSQL; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."__EFMigrationsHistory_PostgreSQL" (
...
--
-- Name: answer_attempts; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.answer_attempts (
    ...
    "SubmittedAnswer" character varying(500) NOT NULL,
...
--
-- Name: child_equipped_items; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.child_equipped_items (
    "Id" uuid NOT NULL,
...
--
-- Name: child_owned_items; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.child_owned_items (
    "Id" uuid NOT NULL,
    "ChildProfileId" uuid NOT NULL,
    "ItemId" uuid NOT NULL,
...
CREATE TABLE public.child_profiles (
    ...
    "AvatarImageUrl" character varying(500),
    "TotalCoins" integer DEFAULT 0 NOT NULL,
...
--
-- Name: child_progress; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.child_progress (
    ...
    "TotalStars" integer DEFAULT 0 NOT NULL,
    "CompletedLevelsCount" integer DEFAULT 0 NOT NULL,
    "CreatedAt" timestamp with time zone NOT NULL,
    "UpdatedAt" timestamp with time zone,
    "IsDeleted" boolean NOT NULL
);
...
CREATE TABLE public.level_results (
    ...
    "SuccessPercentage" numeric(5,2) DEFAULT 0.0 NOT NULL,
...
CREATE TABLE public.levels (
    ...
    "MinCorrectToPass" integer DEFAULT 7 NOT NULL,
    "IsActive" boolean DEFAULT true NOT NULL,
    "CreatedAt" timestamp with time zone NOT NULL,
    "UpdatedAt" timestamp with time zone,
    "IsDeleted" boolean NOT NULL
...
--
-- Name: match_questions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: match_sessions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: __EFMigrationsHistory_PostgreSQL PK___EFMigrationsHistory_PostgreSQL; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."__EFMigrationsHistory_PostgreSQL"
    ADD CONSTRAINT "PK___EFMigrationsHistory_PostgreSQL" PRIMARY KEY ("MigrationId");


--
-- Name: answer_attempts PK_answer_attempts; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.answer_attempts
    ADD CONSTRAINT "PK_answer_attempts" PRIMARY KEY ("Id");


--
-- Name: avatar_items PK_avatar_items; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.avatar_items
    ADD CONSTRAINT "PK_avatar_items" PRIMARY KEY ("Id");


--
-- Name: avatars PK_avatars; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: child_equipped_items PK_child_equipped_items; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.child_equipped_items
    ADD CONSTRAINT "PK_child_equipped_items" PRIMARY KEY ("Id");


--
-- Name: child_owned_items PK_child_owned_items; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.child_owned_items
    ADD CONSTRAINT "PK_child_owned_items" PRIMARY KEY ("Id");


--
-- Name: child_profiles PK_child_profiles; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: child_progress PK_child_progress; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.child_progress
    ADD CONSTRAINT "PK_child_progress" PRIMARY KEY ("Id");


--
-- Name: level_results PK_level_results; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.level_results
    ADD CONSTRAINT "PK_level_results" PRIMARY KEY ("Id");


--
-- Name: levels PK_levels; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: match_answers PK_match_answers; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.match_answers
    ADD CONSTRAINT "PK_match_answers" PRIMARY KEY ("Id");


--
-- Name: match_participants PK_match_participants; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: match_questions PK_match_questions; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.match_questions
    ADD CONSTRAINT "PK_match_questions" PRIMARY KEY ("Id");


--
-- Name: match_requests PK_match_requests; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.match_requests
    ADD CONSTRAINT "PK_match_requests" PRIMARY KEY ("Id");


--
-- Name: match_sessions PK_match_sessions; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.match_sessions
    ADD CONSTRAINT "PK_match_sessions" PRIMARY KEY ("Id");


--
-- Name: parent_profiles PK_parent_profiles; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.parent_profiles
    ADD CONSTRAINT "PK_parent_profiles" PRIMARY KEY ("Id");


--
-- Name: question_options PK_question_options; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: IX_answer_attempts_AttemptedAt; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_answer_attempts_AttemptedAt" ON public.answer_attempts USING btree ("AttemptedAt");


--
-- Name: IX_answer_attempts_ChildId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_answer_attempts_ChildId" ON public.answer_attempts USING btree ("ChildId");


--
-- Name: IX_answer_attempts_QuestionId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_answer_attempts_QuestionId" ON public.answer_attempts USING btree ("QuestionId");


--
-- Name: IX_avatar_items_IsActive; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_avatar_items_IsActive" ON public.avatar_items USING btree ("IsActive");


--
-- Name: IX_avatar_items_ItemType; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_avatar_items_ItemType" ON public.avatar_items USING btree ("ItemType");


--
-- Name: IX_avatar_items_PointCost; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_avatar_items_PointCost" ON public.avatar_items USING btree ("PointCost");


--
-- Name: IX_avatars_IsActive; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_avatars_IsActive" ON public.avatars USING btree ("IsActive");


--
-- Name: IX_avatars_IsDefault; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_avatars_IsDefault" ON public.avatars USING btree ("IsDefault");


--
-- Name: IX_child_equipped_items_ChildProfileId_ItemId; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "IX_child_equipped_items_ChildProfileId_ItemId" ON public.child_equipped_items USING btree ("ChildProfileId", "ItemId") WHERE ("IsDeleted" = false);


--
-- Name: IX_child_equipped_items_ItemId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_child_equipped_items_ItemId" ON public.child_equipped_items USING btree ("ItemId");


--
-- Name: IX_child_owned_items_ChildProfileId_ItemId; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "IX_child_owned_items_ChildProfileId_ItemId" ON public.child_owned_items USING btree ("ChildProfileId", "ItemId") WHERE ("IsDeleted" = false);


--
-- Name: IX_child_owned_items_ItemId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_child_owned_items_ItemId" ON public.child_owned_items USING btree ("ItemId");


--
-- Name: IX_child_profiles_AvatarId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_child_profiles_AvatarId" ON public.child_profiles USING btree ("AvatarId");


--
-- Name: IX_child_profiles_ParentProfileId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_child_profiles_ParentProfileId" ON public.child_profiles USING btree ("ParentProfileId");


--
-- Name: IX_child_progress_ChildId; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "IX_child_progress_ChildId" ON public.child_progress USING btree ("ChildId");


--
-- Name: IX_level_results_ChildId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_level_results_ChildId" ON public.level_results USING btree ("ChildId");


--
-- Name: IX_level_results_ChildId_LevelId; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "IX_level_results_ChildId_LevelId" ON public.level_results USING btree ("ChildId", "LevelId");


--
-- Name: IX_level_results_CompletedAt; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_level_results_CompletedAt" ON public.level_results USING btree ("CompletedAt");


--
-- Name: IX_level_results_LevelId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_level_results_LevelId" ON public.level_results USING btree ("LevelId");


--
-- Name: IX_levels_TopicId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_levels_TopicId" ON public.levels USING btree ("TopicId");


--
-- Name: IX_match_answers_MatchSessionId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_match_answers_MatchSessionId" ON public.match_answers USING btree ("MatchSessionId");


--
-- Name: IX_match_answers_ParticipantId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_match_answers_ParticipantId" ON public.match_answers USING btree ("ParticipantId");


--
-- Name: IX_match_answers_ParticipantId_QuestionId; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "IX_match_answers_ParticipantId_QuestionId" ON public.match_answers USING btree ("ParticipantId", "QuestionId");


--
-- Name: IX_match_answers_QuestionId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_match_answers_QuestionId" ON public.match_answers USING btree ("QuestionId");


--
-- Name: IX_match_participants_ChildProfileId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_match_participants_ChildProfileId" ON public.match_participants USING btree ("ChildProfileId");


--
-- Name: IX_match_participants_MatchSessionId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_match_participants_MatchSessionId" ON public.match_participants USING btree ("MatchSessionId");


--
-- Name: IX_match_questions_MatchSessionId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_match_questions_MatchSessionId" ON public.match_questions USING btree ("MatchSessionId");


--
-- Name: IX_match_questions_MatchSessionId_QuestionOrder; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "IX_match_questions_MatchSessionId_QuestionOrder" ON public.match_questions USING btree ("MatchSessionId", "QuestionOrder");


--
-- Name: IX_match_questions_QuestionId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_match_questions_QuestionId" ON public.match_questions USING btree ("QuestionId");


--
-- Name: IX_match_requests_ChildProfileId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_match_requests_ChildProfileId" ON public.match_requests USING btree ("ChildProfileId");


--
-- Name: IX_match_requests_MatchSessionId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_match_requests_MatchSessionId" ON public.match_requests USING btree ("MatchSessionId");


--
-- Name: IX_match_requests_RequestedAt; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_match_requests_RequestedAt" ON public.match_requests USING btree ("RequestedAt");


--
-- Name: IX_match_requests_Status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_match_requests_Status" ON public.match_requests USING btree ("Status");


--
-- Name: IX_match_sessions_CreatedAt; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_match_sessions_CreatedAt" ON public.match_sessions USING btree ("CreatedAt");


--
-- Name: IX_match_sessions_Status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_match_sessions_Status" ON public.match_sessions USING btree ("Status");


--
-- Name: IX_parent_profiles_UserId; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "IX_parent_profiles_UserId" ON public.parent_profiles USING btree ("UserId");


--
-- Name: IX_question_options_QuestionId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_question_options_QuestionId" ON public.question_options USING btree ("QuestionId");


--
-- Name: IX_questions_LevelId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_questions_LevelId" ON public.questions USING btree ("LevelId");
...
--
-- Name: IX_topics_SubjectId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_topics_SubjectId" ON public.topics USING btree ("SubjectId");
...
--
-- Name: answer_attempts FK_answer_attempts_child_profiles_ChildId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.answer_attempts
    ADD CONSTRAINT "FK_answer_attempts_child_profiles_ChildId" FOREIGN KEY ("ChildId") REFERENCES public.child_profiles("Id") ON DELETE CASCADE;


--
-- Name: answer_attempts FK_answer_attempts_questions_QuestionId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.answer_attempts
    ADD CONSTRAINT "FK_answer_attempts_questions_QuestionId" FOREIGN KEY ("QuestionId") REFERENCES public.questions("Id") ON DELETE CASCADE;


--
-- Name: child_equipped_items FK_child_equipped_items_avatar_items_ItemId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.child_equipped_items
    ADD CONSTRAINT "FK_child_equipped_items_avatar_items_ItemId" FOREIGN KEY ("ItemId") REFERENCES public.avatar_items("Id") ON DELETE CASCADE;


--
-- Name: child_equipped_items FK_child_equipped_items_child_profiles_ChildProfileId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.child_equipped_items
    ADD CONSTRAINT "FK_child_equipped_items_child_profiles_ChildProfileId" FOREIGN KEY ("ChildProfileId") REFERENCES public.child_profiles("Id") ON DELETE CASCADE;


--
-- Name: child_owned_items FK_child_owned_items_avatar_items_ItemId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.child_owned_items
    ADD CONSTRAINT "FK_child_owned_items_avatar_items_ItemId" FOREIGN KEY ("ItemId") REFERENCES public.avatar_items("Id") ON DELETE CASCADE;


--
-- Name: child_owned_items FK_child_owned_items_child_profiles_ChildProfileId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.child_owned_items
    ADD CONSTRAINT "FK_child_owned_items_child_profiles_ChildProfileId" FOREIGN KEY ("ChildProfileId") REFERENCES public.child_profiles("Id") ON DELETE CASCADE;


--
-- Name: child_profiles FK_child_profiles_avatars_AvatarId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.child_profiles
    ADD CONSTRAINT "FK_child_profiles_avatars_AvatarId" FOREIGN KEY ("AvatarId") REFERENCES public.avatars("Id") ON DELETE RESTRICT;


--
-- Name: child_profiles FK_child_profiles_parent_profiles_ParentProfileId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.child_profiles
    ADD CONSTRAINT "FK_child_profiles_parent_profiles_ParentProfileId" FOREIGN KEY ("ParentProfileId") REFERENCES public.parent_profiles("Id") ON DELETE CASCADE;


--
-- Name: child_progress FK_child_progress_child_profiles_ChildId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.child_progress
    ADD CONSTRAINT "FK_child_progress_child_profiles_ChildId" FOREIGN KEY ("ChildId") REFERENCES public.child_profiles("Id") ON DELETE CASCADE;


--
-- Name: level_results FK_level_results_child_profiles_ChildId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.level_results
    ADD CONSTRAINT "FK_level_results_child_profiles_ChildId" FOREIGN KEY ("ChildId") REFERENCES public.child_profiles("Id") ON DELETE CASCADE;


--
-- Name: level_results FK_level_results_levels_LevelId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.level_results
    ADD CONSTRAINT "FK_level_results_levels_LevelId" FOREIGN KEY ("LevelId") REFERENCES public.levels("Id") ON DELETE CASCADE;


--
-- Name: levels FK_levels_topics_TopicId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.levels
    ADD CONSTRAINT "FK_levels_topics_TopicId" FOREIGN KEY ("TopicId") REFERENCES public.topics("Id") ON DELETE CASCADE;


--
-- Name: match_answers FK_match_answers_match_participants_ParticipantId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.match_answers
    ADD CONSTRAINT "FK_match_answers_match_participants_ParticipantId" FOREIGN KEY ("ParticipantId") REFERENCES public.match_participants("Id") ON DELETE CASCADE;


--
-- Name: match_answers FK_match_answers_match_sessions_MatchSessionId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.match_answers
    ADD CONSTRAINT "FK_match_answers_match_sessions_MatchSessionId" FOREIGN KEY ("MatchSessionId") REFERENCES public.match_sessions("Id") ON DELETE CASCADE;


--
-- Name: match_answers FK_match_answers_questions_QuestionId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.match_answers
    ADD CONSTRAINT "FK_match_answers_questions_QuestionId" FOREIGN KEY ("QuestionId") REFERENCES public.questions("Id") ON DELETE CASCADE;


--
-- Name: match_participants FK_match_participants_child_profiles_ChildProfileId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.match_participants
    ADD CONSTRAINT "FK_match_participants_child_profiles_ChildProfileId" FOREIGN KEY ("ChildProfileId") REFERENCES public.child_profiles("Id") ON DELETE CASCADE;


--
-- Name: match_participants FK_match_participants_match_sessions_MatchSessionId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.match_participants
    ADD CONSTRAINT "FK_match_participants_match_sessions_MatchSessionId" FOREIGN KEY ("MatchSessionId") REFERENCES public.match_sessions("Id") ON DELETE CASCADE;


--
-- Name: match_questions FK_match_questions_match_sessions_MatchSessionId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.match_questions
    ADD CONSTRAINT "FK_match_questions_match_sessions_MatchSessionId" FOREIGN KEY ("MatchSessionId") REFERENCES public.match_sessions("Id") ON DELETE CASCADE;


--
-- Name: match_questions FK_match_questions_questions_QuestionId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.match_questions
    ADD CONSTRAINT "FK_match_questions_questions_QuestionId" FOREIGN KEY ("QuestionId") REFERENCES public.questions("Id") ON DELETE CASCADE;


--
-- Name: match_requests FK_match_requests_child_profiles_ChildProfileId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.match_requests
    ADD CONSTRAINT "FK_match_requests_child_profiles_ChildProfileId" FOREIGN KEY ("ChildProfileId") REFERENCES public.child_profiles("Id") ON DELETE CASCADE;


--
-- Name: match_requests FK_match_requests_match_sessions_MatchSessionId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.match_requests
    ADD CONSTRAINT "FK_match_requests_match_sessions_MatchSessionId" FOREIGN KEY ("MatchSessionId") REFERENCES public.match_sessions("Id") ON DELETE SET NULL;


--
-- Name: parent_profiles FK_parent_profiles_users_UserId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.parent_profiles
    ADD CONSTRAINT "FK_parent_profiles_users_UserId" FOREIGN KEY ("UserId") REFERENCES public.users("Id") ON DELETE CASCADE;


--
-- Name: question_options FK_question_options_questions_QuestionId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.question_options
    ADD CONSTRAINT "FK_question_options_questions_QuestionId" FOREIGN KEY ("QuestionId") REFERENCES public.questions("Id") ON DELETE CASCADE;


--
-- Name: questions FK_questions_levels_LevelId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.questions
    ADD CONSTRAINT "FK_questions_levels_LevelId" FOREIGN KEY ("LevelId") REFERENCES public.levels("Id") ON DELETE CASCADE;
...
--
-- Name: topics FK_topics_subjects_SubjectId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.topics
    ADD CONSTRAINT "FK_topics_subjects_SubjectId" FOREIGN KEY ("SubjectId") REFERENCES public.subjects("Id") ON DELETE CASCADE;
...
\unrestrict NbNUHiuLQTyCMvXfptp07SI4ZFFbV7t7WObyCe5U4OEyO8W4BhqmZont9ESYVsN
